...
export const appRouter = router({
  ...
  admin: router({
    summary: adminProcedure.query(() => getAdminSummary()), users: adminProcedure.query(() => getAdminUsers()), drivers: adminProcedure.query(() => getAdminDrivers()), orders: adminProcedure.query(() => getAdminOrders()), payments: adminProcedure.query(() => getAdminPaymentOrders()), supportInbox: adminProcedure.query(({ ctx }) => getAdminSupportInbox(ctx.user.id)),
